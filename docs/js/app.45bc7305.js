...
// docs/js/modules/chart-config.js
var PLOTLY_CONFIG = {
  responsive: true,
  displaylogo: false,
...
// docs/js/modules/ChartRenderer.js
...
// docs/js/modules/TableRenderer.js
...
// docs/js/modules/DataExporter.js
...
// docs/js/modules/CommentRenderer.js
...
// docs/js/services/PyodideService.js
